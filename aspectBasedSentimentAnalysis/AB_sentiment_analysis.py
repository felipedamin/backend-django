...
pos_txt=open('./aspectBasedSentimentAnalysis/positive-words.txt').read()
pos=pos_txt[1282:].split("\n")

neg_txt=open('./aspectBasedSentimentAnalysis/negative-words.txt').read()
...
if __name__ == "__main__":
    print(feature_sentiment("Gostei do meu chefe mas odeiei meu sálario"))
